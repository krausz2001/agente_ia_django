        ...
        if pergunta:
            ...
            try:
                ...
                for msg in historico:
                    prefixo = "Usuário:" if msg.autor == "usuario" else "Tey Magia:"
                    contexto += f"{prefixo} {msg.mensagem}\n"

                prompt = f"""{contexto}
Responda a última mensagem do usuário, levando em conta o contexto acima.
Você é Tey Magia, agente de IA da Olimpo Real Estate. Fale em português, de forma objetiva e profissional."""
